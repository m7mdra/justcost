...
class MyProductEdit extends StatefulWidget {
  ...
  const MyProductEdit({Key key,this.from,this.product})
      : super(key: key);
...
class _MyProductEditState extends State<MyProductEdit> {
  ...
  void initState() {
    ...
    _bloc =
      ...
      _oldPriceController.text = widget.product.regPrice.toString();
      _newPriceController.text = widget.product.salePrice.toString();
      _detailsController.text = widget.product.description;
      _category.name = widget.product.categoryAr;
      _brand.name = widget.product.brand;
...
////                          ));
                ...
                print('${_oldPriceController.text}');
                print('${_newPriceController.text}');
                print('${_category.id}');
                print('${_brand.id}');
                ...
                _bloc.dispatch(UpdateProduct(
                    ...
                    salePrice: _newPriceController.text,
                    categoryId: _category.id,
                    brandId: _brand.id,
...
//                        Text(AppLocalizations.of(context).adSubmitSuccessMessage),
                  Text('سوف يصلك اشعار اذا تم الموافقة علي تعديل المنتج'),
                  const SizedBox(
                    height: 8,
                  ),
                  RaisedButton(
...
////                          ));
                            ...
                            print(_newPriceController.text);
                            print(_detailsController.text);
                            print('${_brand.name}    ${_brand.id}');
                            print('${_category.name}    ${_category.id}');
                          },
